            ...
            <section className={styles.section}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '20px' }}>
                    <div>
                        ...
                        />
                        <img
                            src={logoLeft || "/assets/logo.webp"}
                            alt="Left logo preview"
                            style={{ height: 48, marginTop: 8, objectFit: 'contain', borderRadius: 4, background: '#fff' }}
                            onError={(e) => { (e.currentTarget as HTMLImageElement).src = "/assets/eadvocate.webp"; }}
                        />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            placeholder="/assets/health.webp"
                        />
                        <img
                            src={logoRight || "/assets/logo.webp"}
                    ...
                    <div>
                        ...
                        />
                        <img
                            src={logoHero || "/assets/health.webp"}
                            alt="Hero logo preview"
                            style={{ height: 48, marginTop: 8, objectFit: 'contain', borderRadius: 4, background: '#fff' }}
                            onError={(e) => { (e.currentTarget as HTMLImageElement).src = "/assets/health.webp"; }}
                        />"
                    </div>
                </div>
            </section> 
