    ...
    return (
        <div className={styles.aboutPage}>
            <div className={styles.aboutContainer}>
                ...
                {/* Header */}
                <div className={styles.headerSection}>
                    <div className={styles.badge}>TRUSTED HEALTHCARE ECOSYSTEM</div>
                    <h1 className={styles.title}>About Tatito Health Plus</h1>
                    <p className={styles.subtitle}>
                        Tatito Health Plus is a comprehensive digital healthcare ecosystem designed
                        to modernize medical access by seamlessly integrating doctors, diagnostics,
                        laboratories, pharmacies, and digital health records into a single platform.
                    </p>
                </div>
                ...
                <div className={styles.aboutContent}>
                    ...
                    <div className={styles.fullWidthCard}>
                        <div className={styles.cardHeader}>
                            <div className={styles.headerIcon}><Scale size={28} /></div>
                            <div className={styles.headerText}>
                                <h2>About Tatito Health Plus Services</h2>
                                <div className={styles.headerSubtitle}>End-to-End Digital Healthcare Infrastructure</div>
                            </div>
                        </div>

                        <div className={styles.cardContent}>
                            <p>
                                Tatito Health Plus is built to address the fragmented nature of traditional
                                healthcare systems. Patients often struggle with disconnected services,
                                multiple providers, delayed diagnostics, and scattered medical records.
                                Our platform unifies these components into a centralized digital experience.
                            </p>

                            <p>
                                By leveraging secure cloud infrastructure, verified medical networks,
                                and patient-centric workflows, Tatito Health Plus ensures continuity of care
                                from the first consultation to diagnosis, treatment, and long-term follow-up.
                            </p>

                            <p>
                                We focus not only on treatment but also on prevention, early detection,
                                chronic disease management, and long-term wellness support.
                            </p>

                            <h3>Comprehensive Healthcare Offerings:</h3>
                            <ul>
                                <li><strong>Doctor Consultations:</strong> General physicians, specialists, super-specialists via online, video, and physical visits</li>
                                <li><strong>Diagnostics & Imaging:</strong> Blood tests, scans, imaging, and preventive screenings</li>
                                <li><strong>Laboratory Services:</strong> Certified lab testing with quality assurance</li>
                                <li><strong>Medicine Delivery:</strong> Prescription and OTC medicine fulfillment</li>
                                <li><strong>Health Records:</strong> Centralized lifetime medical history</li>
                                <li><strong>Preventive Healthcare:</strong> Wellness programs, annual health plans, screenings</li>
                            </ul>

                            <p>
                                <strong>Our Philosophy:</strong> Healthcare should be simple, transparent,
                                affordable, and accessible to every individual regardless of location
                                or background.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={styles.fullWidthCard}>
                        <div className={styles.cardHeader}>
                            <div className={styles.headerIcon}><Users size={28} /></div>
                            <div className={styles.headerText}>
                                <h2>Browse Profiles</h2>
                                <div className={styles.headerSubtitle}>Verified Doctors, Labs & Diagnostic Centers</div>
                            </div>
                        </div>

                        <div className={styles.cardContent}>
                            <p>
                                Choosing the right healthcare provider is critical. Tatito Health Plus
                                enables patients to explore detailed, verified profiles of doctors,
                                laboratories, and diagnostic centers with complete transparency.
                            </p>

                            <p>
                                Every profile on the platform undergoes strict verification to ensure
                                professional credibility, medical qualifications, and regulatory compliance.
                            </p>

                            <p>
                                Our intelligent discovery system allows patients to make informed
                                decisions based on expertise, experience, availability, and patient feedback.
                            </p>

                            <h3>Advanced Profile Features:</h3>
                            <ul>
                                <li>Search by specialization, symptoms, experience & city</li>
                                <li>View academic qualifications and certifications</li>
                                <li>Consultation fees and availability transparency</li>
                                <li>Patient ratings and service feedback</li>
                                <li>Multi-language consultation options</li>
                                <li>Instant booking and appointment management</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className={styles.fullWidthCard}>
                        <div className={styles.cardHeader}>
                            <div className={styles.headerIcon}><FileText size={28} /></div>
                            <div className={styles.headerText}>
                                <h2>Diagnostic Services</h2>
                                <div className={styles.headerSubtitle}>Reliable Testing with Clinical Accuracy</div>
                            </div>
                        </div>

                        <div className={styles.cardContent}>
                            <p>
                                Diagnostics form the backbone of effective healthcare. Tatito Health Plus
                                partners with trusted diagnostic centers to deliver accurate and timely
                                test results.
                            </p>

                            <p>
                                Our diagnostic services cover routine tests, advanced investigations,
                                preventive screenings, and chronic condition monitoring.
                            </p>

                            <p>
                                All tests follow standardized protocols ensuring safety, precision,
                                and regulatory compliance.
                            </p>

                            <ul>
                                <li>Blood, urine & pathology tests</li>
                                <li>Radiology & imaging services</li>
                                <li>Preventive health check packages</li>
                                <li>Home sample collection services</li>
                                <li>Digital reports with doctor access</li>
                                <li>Historical test trend analysis</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className={styles.fullWidthCard}>
                        <div className={styles.cardHeader}>
                            <div className={styles.headerIcon}><Target size={28} /></div>
                            <div className={styles.headerText}>
                                <h2>Laboratory Services</h2>
                                <div className={styles.headerSubtitle}>Quality-Controlled & Certified Labs</div>
                            </div>
                        </div>

                        <div className={styles.cardContent}>
                            <p>
                                Tatito Health Plus works exclusively with NABL-certified laboratories
                                that meet national and international testing standards.
                            </p>

                            <p>
                                Each sample is handled with strict quality control, traceability,
                                and hygiene protocols to maintain result integrity.
                            </p>

                            <p>
                                Technology-enabled sample tracking ensures complete transparency from
                                collection to report delivery.
                            </p>

                            <ul>
                                <li>Barcode-based sample identification</li>
                                <li>Cold-chain logistics for sensitive samples</li>
                                <li>Multi-stage quality checks</li>
                                <li>Secure cloud-based reports</li>
                                <li>Access to long-term lab history</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className={styles.fullWidthCard}>
                        <div className={styles.cardHeader}>
                            <div className={styles.headerIcon}><Shield size={28} /></div>
                            <div className={styles.headerText}>
                                <h2>Medicine Delivery</h2>
                                <div className={styles.headerSubtitle}>Licensed Pharmacies & Safe Fulfillment</div>
                            </div>
                        </div>

                        <div className={styles.cardContent}>
                            <p>
                                Tatito Health Plus simplifies medicine access by partnering with licensed
                                pharmacies that comply with storage, handling, and dispensing regulations.
                            </p>

                            <p>
                                Our system ensures prescription validation, medicine authenticity,
                                and safe delivery directly to patients.
                            </p>

                            <ul>
                                <li>Prescription & non-prescription medicines</li>
                                <li>Chronic care medicine programs</li>
                                <li>Auto-refill & reminder services</li>
                    ...
                    <div className={styles.fullWidthCard}>
                        <div className={styles.cardHeader}>
                            <div className={styles.headerIcon}><MessageSquare size={28} /></div>
                            <div className={styles.headerText}>
                                <h2>Health Blogs & Resources</h2>
                                <div className={styles.headerSubtitle}>Medical Knowledge & Awareness</div>
                            </div>
                        </div>

                        <div className={styles.cardContent}>
                            <p>
                                Our knowledge platform empowers individuals with doctor-reviewed,
                                evidence-based healthcare information.
                            </p>

                            <p>
                                The goal is to promote preventive healthcare, early awareness,
                                and informed medical decisions.
                            </p>

                            <ul>
                                <li>Disease education & symptom awareness</li>
                                <li>Preventive health guidance</li>
                                <li>Mental health & wellness resources</li>
                                <li>Nutrition & lifestyle content</li>
                                <li>Public health & medical updates</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className={styles.fullWidthCard}>
                        <div className={styles.cardHeader}>
                            <div className={styles.headerIcon}><Zap size={28} /></div>
                            <div className={styles.headerText}>
                                <h2>Mission & Vision</h2>
                                <div className={styles.headerSubtitle}>Purpose-Driven Healthcare</div>
                            </div>
                        </div>
                        ...
                        <div className={styles.cardContent}>
                            <h3>Our Mission</h3>
                            <p>
                                To transform healthcare access through digital innovation while ensuring
                                affordability, quality, and patient trust.
                            </p>

                            <h3>Our Vision</h3>
                            <p>
                                To become India’s most reliable digital healthcare ecosystem delivering
                                lifelong wellness support to individuals and families.
                            </p>
                        </div>
                    </div>

                    {/* 8. Approvals & Partnerships */}
                    <div className={styles.fullWidthCard}>
                        <div className={styles.cardHeader}>
                            <div className={styles.headerIcon}><Award size={28} /></div>
                            <div className={styles.headerText}>
                                <h2>Approvals & Partnerships</h2>
                                <div className={styles.headerSubtitle}>Regulatory Compliance & Trust Framework</div>
                            </div>
                        </div>

                        <div className={styles.cardContent}>
                            <p>
                                Tatito Health Plus operates under strict regulatory compliance frameworks
                                ensuring patient safety, data privacy, and service reliability.
                            </p>

                            <ul>
                                <li>Verified medical professionals & institutions</li>
                                <li>Certified labs & diagnostic partners</li>
                                <li>DPDP Act compliant data protection</li>
                                <li>Encrypted health records & communications</li>
                                <li>PCI-DSS compliant payment infrastructure</li>
                            </ul>
                        </div>
                    </div>
