                            ...
                            <div className={styles.addMoneyForm}>
                                ...
                                {addAmount && parseFloat(addAmount) > 0 && (
                                    <div className={styles.taxSummary}>
                                        ...
                                        <div className={styles.taxRow}>
                                            <span>Convenience Fee (0.3%)</span>
                                            <span>+ ₹{(parseFloat(addAmount) * 0.003).toFixed(2)}</span>
                                        </div>
                                    ...
                                    <button
                                        ...
                                        onClick={async () => {
                                            ...
                                            try {
                                                ...
                                                const totalVal = calculateTotalPayable(baseVal); // Includes GST & fees
