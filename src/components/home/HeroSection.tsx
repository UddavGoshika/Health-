            ...
            <div className={styles.container}>
                ...
                <div className={styles.left}>
                    <div className={styles.logoCircle}>
                        <img src={settings?.logo_url_hero || "/assets/health.webp"} alt="health plus Logo" />
                    </div>
                    <div className={styles.titleContainer}>
                        <h1 className={styles.mainTitle}>{settings?.hero_title || "Health+"}</h1>
                        <p className={styles.mainSubtitle}>
                            {settings?.hero_subtitle || "Health Plus brings quality healthcare closer to you Consult certified doctors, book tests, and get expert advice with ease."}
                        </p>
