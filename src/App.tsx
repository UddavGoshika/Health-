...
import HealthCheackPage from './pages/HealthCheackPage';
import UploadPrescription from './pages/UploadPrescription';
import DownloadLabReports from './pages/DownloadLabReports';
        ...
        <Router>
          ...
          <Routes>
            ...
            <Route path="/" element={
              ...
              <Route path="/labs/:category" element={<HealthCheackPage />} />
              <Route path="/labs/upload-prescription" element={<UploadPrescription />} />
              <Route path="labs/download-reports" element={<DownloadLabReports />} />
              <Route path="medicine-delivery" element={<BuyMedicines />} />
